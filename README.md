...
> **Note**
> Everywhere in this repository, make sure to replace `anthony81799/custom_fedora` with the details of your own repository. Unless you used [`create-ublue-image`](https://github.com/EinoHR/create-ublue-image), in which case the previous repo identifier should already be your repo's details.
...
```
sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/anthony81799/custom_fedora:latest
```

This repository builds date tags as well, so if you want to rebase to a particular day's build:

```
sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/anthony81799/custom_fedora:20230403
```
...
These images are signed with sisgstore's [cosign](https://docs.sigstore.dev/cosign/overview/). You can verify the signature by downloading the `cosign.pub` key from this repo and running the following command:
    ...
    cosign verify --key cosign.pub ghcr.io/anthony81799/custom_fedora
